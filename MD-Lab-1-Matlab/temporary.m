...
% Script adapted from original work by Douglas Spearot (U. Arkansas / U. Florida) 
    ...
    [Etotal,force,chainlen]=LJ_atom_array(x,eps,sigma,numNN);
    ...
    for itime=1:1:nsteps
        ...
        [Etotal,forces(itime+1,:),chainlen]=LJ_atom_array(pos(itime+1,:),eps,sigma,numNN);
