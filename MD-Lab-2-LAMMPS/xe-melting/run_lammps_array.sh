...
#SBATCH --ntasks=6   # number of processor cores (i.e. tasks) - you'll usually want more than this
...
LISTA='130' # list of lattice constants to be evaluated - list should be space separated


for a in $LISTA
do
    echo "t $a"
    srun ./lmp_mpi < xenon.in -var n 6 -var t $a
    echo "Finished"
